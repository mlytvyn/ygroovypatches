package ygroovypatchespackage.jalo;
...
/**
 * This is the extension manager of the YGroovypatches extension.
 */
public class YGroovypatchesManager extends GeneratedYGroovypatchesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LogManager.getLogger(YGroovypatchesManager.class);
	 ...
	 */
	public static YGroovypatchesManager getInstance()
	{
		return (YGroovypatchesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(YGroovypatchesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public YGroovypatchesManager() // NOPMD 
	{
		LOG.debug("constructor of YGroovypatchesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of YGroovypatchesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of YGroovypatchesManager called, current tenant: {}", getTenant().getTenantID());
	}
